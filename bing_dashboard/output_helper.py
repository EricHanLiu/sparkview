...
def output_budget_opportunities(budget_opportunities, campaign_id):
    if budget_opportunities is not None and len(budget_opportunities) > 0:
        for budget_opportunity in budget_opportunities['BudgetOpportunity']:
            ...
            output_status_message(
                "PercentageIncreaseInClicks: {0}".format(budget_opportunity.PercentageIncreaseInClicks))
            output_status_message(
                "PercentageIncreaseInImpressions: {0}".format(budget_opportunity.PercentageIncreaseInImpressions))
...
def output_bulk_performance_data(performance_data):
    if performance_data is not None:
        ...
        output_status_message(
            "AverageCostPerThousandImpressions: {0}".format(performance_data.average_cost_per_thousand_impressions))
...
def output_bulk_campaign_app_ad_extensions(bulk_entities):
    for entity in bulk_entities:
        ...
        if entity.ad_extension_id_to_entity_id_association is not None:
            output_status_message(
                "AdExtensionId: {0}".format(entity.ad_extension_id_to_entity_id_association.AdExtensionId))
...
def output_keyword(keyword):
    if keyword is not None:
        ...
        if keyword.ForwardCompatibilityMap is not None and len(
                keyword.ForwardCompatibilityMap.KeyValuePairOfstringstring) > 0:
...
def output_campaign(campaign):
    if campaign is not None:
        ...
        output_status_message("ForwardCompatibilityMap: ")
        if campaign.ForwardCompatibilityMap is not None and len(
                campaign.ForwardCompatibilityMap.KeyValuePairOfstringstring) > 0:
...
def output_ad_group(ad_group):
    if ad_group is not None:
        ...
        output_status_message("ForwardCompatibilityMap: ")
        if ad_group.ForwardCompatibilityMap is not None and len(
                ad_group.ForwardCompatibilityMap.KeyValuePairOfstringstring) > 0:
        ...
        if hasattr(ad_extension_editorial_reason_collection, 'Reasons'):
            ...
            for ad_extension_editorial_reason \
                ...
                if ad_extension_editorial_reason is not None \
                    ...
                    output_status_message(
                        "Editorial Rejection Location: {0}".format(ad_extension_editorial_reason.Location))
                    ...
                    output_status_message(
                        "Editorial Rejection ReasonCode: {0}".format(ad_extension_editorial_reason.ReasonCode))
...
def output_audience(audience):
    if audience is not None:
        ...
        output_status_message("ForwardCompatibilityMap: ")
        if audience.ForwardCompatibilityMap is not None and len(
                audience.ForwardCompatibilityMap.KeyValuePairOfstringstring) > 0:
...
def output_campaign_criterion(campaign_criterion):
    if campaign_criterion is not None:
        ...
        if campaign_criterion.ForwardCompatibilityMap is not None and len(
                campaign_criterion.ForwardCompatibilityMap.KeyValuePairOfstringstring) > 0:
