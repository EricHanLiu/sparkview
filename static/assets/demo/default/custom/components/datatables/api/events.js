  ...
  var t = function() {
    ...
    e = function() {
      $(".m_datatable").on("m-datatable--on-init", function() {
        ...
        a("Layout render updated")
      }).on("m-datatable--on-ajax-done", function() {
        a("Ajax data successfully updated")
      }).on("m-datatable--on-ajax-fail", function(t, e) {
        a("Ajax error")
      }).on("m-datatable--on-goto-page", function(t, e) {
        a("Goto to pagination: " + e.page)
      }).on("m-datatable--on-update-perpage", function(t, e) {
        a("Update page size: " + e.perpage)
      }).on("m-datatable--on-reloaded", function(t) {
        a("Datatable reloaded")
      }).on("m-datatable--on-check", function(t, e) {
        a("Checkbox active: " + e.toString())
      }).on("m-datatable--on-uncheck", function(t, e) {
        a("Checkbox inactive: " + e.toString())
      }).on("m-datatable--on-sort", function(t, e) {
        a("Datatable sorted by " + e.field + " " + e.sort)
      })
    },
    a = function(t) {
      var e = $("#m_datatable_console").append(t + "\t\n");
