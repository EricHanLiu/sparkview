...
urlpatterns = [
    ...
    url(r'^reports/set_due_date$', views.set_due_date, name='set_due_date'),
    ...
    url(r'^accounts/resolve_opportunity$', views.resolve_opportunity, name='resolve_opportunity'),
    url(r'^accounts/update_opportunity', views.update_opportunity, name='update_opportunity'),
